...
public class ExcelDataSource : MonoBehaviour 
{
	public BaseData[] EditorBaseData; //修改此数据结构以适应不同的需求
	public ExcelData _excelData;


	[SerializeField][HideInInspector] string _filePath = "UserLevel";
	public string FilePath{set{_filePath = value;} get{return _filePath;}}
	...
	void Start () 
	{
		...
		_excelData.OpenFile(_filePath,_fileType);
